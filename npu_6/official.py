...
from evaluation_validation import read_evaluation_config, validate_task_order  # noqa: E402
...
def validate_candidate_structure(graph, plan, scene):
    """Run cheap official structural checks before invoking the simulator."""
