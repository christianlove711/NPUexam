"""Sixth-version seeded official search and resumable batch runner."""
...
def main(argv=None):
    ...
    if prior:
        ...
        manifest = {"algorithm": "npu_6_seeded_refinement", "created_at": datetime.now().astimezone().isoformat(), **identity}
