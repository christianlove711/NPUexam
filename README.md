...
`多核调度_第四版/` 是在完整版基础上继续开发的粒度搜索版本。它保留旧方案作为保底，按问题一、问题二和问题三分别调用官方评估器选择更细的切图方案。

100 个用例、2～5 核的全量结果如下。每个场景统计 400 个配置：

| 场景 | 第三版平均加速比 | 第四版平均加速比 | 严格改善配置 |
|---|---:|---:|---:|
| 问题一 A | 1.6879 | 1.9361 | 308/400 |
| 问题二 B | 1.8330 | 2.5441 | 372/400 |
| 问题三 L2 | 1.8581 | 2.5889 | 370/400 |

正式摘要、图表、核验记录和建模说明见 [多核调度_第四版](多核调度_第四版/README.md) 及其 `results/`。第四版的完整逐组运行记录位于 [`多核调度_第四版/runs/20260923_141723_v4`](多核调度_第四版/runs/20260923_141723_v4)，运行入口所需的第三版保底记录位于 [`多核调度_第三版/runs/20260923_123805_9a3ab0`](多核调度_第三版/runs/20260923_123805_9a3ab0)。官方 `code/` 和 `data/` 也在仓库中。
